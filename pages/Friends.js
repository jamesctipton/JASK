...
export const Friends = () => {
    ...
    return (
        <Flex style={{justifyContent: 'center', alignContent: 'center', marginTop: '12%'}}>
            <Text style={{fontSize: 50, fontWeight: 'bold', marginRight: 'auto', marginLeft: 'auto'}}>Our E-Mission</Text>
            <Text></Text>
            <Text style={{fontSize: 20, marginRight: 10, marginLeft: 10, borderColor: '#4caf50', borderWidth: 4, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 8, backgroundColor: '#d3ffb9', }}>
